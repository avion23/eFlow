...
void handleProcessStart() {
	...
	String message = "";
	message +=
			"<meta http-equiv=\"refresh\" content=\"1; url=/process/chart\">\n";
...
void handleProcessConfigure() {
	...
	message +=
			"<form action='/process/conf/save/global' method='post' name='form1' target='_self' id='form1'>\n";
	message += "  <h1>Configure System</h2>\n";
	message += "  <h2>Set Global PID Values</h2>\n";
	message += "  <p>Kp\n";
	message +=
			"    <input name='Kp' type='text' id='textfield13' size='5' maxlength='5' value='"
					+ String(Kp) + "'/>\n";
	message += "  </p>\n";
	message += "  <p>Ki\n";
	message +=
			"    <input name='Ki' type='text' id='textfield16' size='5' maxlength='5' value='"
					+ String(Ki) + "'/>\n";
	message += "  </p>\n";
	message += "  <p>Kd\n";
	message +=
			"    <input name='Kd' type='text' id='textfield14' size='5' maxlength='5' value='"
					+ String(Kd) + "'/>\n";
	message += "  </p>\n";
	message +=
			"  <p>For more information, see the Wikipedia article on <a href='https://en.wikipedia.org/wiki/PID_controller' target='new'>PID Controller</a>.</p>\n";
	message += "  <h2>Set Oven Start Point</h2>\n";
	message += "  <p>\n";
	message +=
			"    <input name='startup_sec' type='text' id='textfield15' size='3' maxlength='3' value="
					+ String(startup_sec) + " /> Sec\n";
	message +=
			"<input name='startup_temp' type='text' id='textfield17' size='3' maxlength='3' value="
					+ String(startup_temp) + " />\n";
	message += "&deg;Celsius </p>\n";
	message +=
			"  <p>Before beginning the reflow profile, heat the oven to a known start point and maintain it for a few seconds. This allows you to monitor the oven's performance prior to extreme temepratures. If the oven is unable to maintain the start temperature, the process will be aborted.</p>\n";
//  message += "  <hr />\n";
	message += "  <h2>Safe Temperature</h2>\n";
	message += "  <p>\n";
	message +=
			"    <input name='safeTemperature' type='text' id='textfield15' size='3' maxlength='3' value="
					+ String(safeTemperature) + " /> Sec\n";
	message +=
			"  The reflow process can't be started unless the oven is below the safe temperature.<p>\n";
	message += "  <h2>Process Agressiveness</h2>\n";
	message += "  <p>\n";
	message +=
			"    <input name='processAgressiveness' type='text' id='textfield15' size='3' maxlength='3' value="
					+ String(processAgressiveness) + " /> Sec\n";
	message +=
			"  At the start of each zone in the reflow profile, be agressive for a few seconds to get close to the upcoming setpoint.<p>\n";
	message += "  <h2>Process Temperature Hysteresis</h2>\n";
	message += "  <p>\n";
	message +=
			"    <input name='processTempHysteresis' type='text' id='textfield15' size='3' maxlength='3' value="
					+ String(processTempHysteresis) + " /> Sec\n";
	message +=
			"  Temeprature range below set point to accept zone completion.<p>\n";
	message += "  <p>\n";
	message += "    Reset Form\n";
	message +=
	...
	message +=
			"    <input type='submit' name='button' id='button2' value='Apply' />\n";
	message += "  </p>\n";
	message += "</form>\n";
...
void handleProcessConfigureSaveGlobal() {
	...
	message += "  <link rel=\"stylesheet\" href=\"/eflow.css\">\n";
	message +=
			"<meta http-equiv=\"refresh\" content=\"1; url=/process/conf\">\n";
...
void handleSystemRestart() {
	...
	message += "  <link rel=\"stylesheet\" href=\"/eflow.css\">\n";
	message +=
			"<meta http-equiv=\"refresh\" content=\"10; url=/blank.html\">\n";
...
void handleReflowNav() {
	...
	message +=
			F(
					"  <table width='100%' height='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width=200><font size=+3><b>eFlow v0.01</b></font></td><td align='center' valign='middle'>\n");
	...
	message += F(
			"  <a href=/process/chart target=bottom>Monitor Progress</a> | \n");
...
void handleBlank() {
	...
	message += "<body>\n";
	message +=
			"<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>eFlow v0.0.1 (c) 2016 by Jm Casler\n";
...
//  message += "    document.chartForm.sensorB.value = res.data.sensorB;\n";
	...
	message +=
			"    document.chartForm.processReflowTimer.value = res.data.processReflowTimer;\n";
	...
	message +=
			"    document.chartForm.systemMessage.value = res.data.systemMessage;\n";
	message += "    }\n";
	message += "  }\n";
	message += "}\n";
	...
	message += "<body>\n";
	message +=
			"<form action='' method='post' name='chartForm' target='_self' id='chartForm'>\n";
	message +=
			"  SensorA  <input name='sensorA' type='text' id='textfield13' size='5' maxlength='5' value=''/>\n";
//  message += "  SensorB  <input name='sensorB' type='text' id='textfield13' size='5' maxlength='5' value=''/>\n";
	message +=
			"  Set Point  <input name='Setpoint' type='text' id='textfield13' size='3' maxlength='3' value=''/>\n";
	message +=
			"  Process Timer  <input name='processTimer' type='text' id='textfield13' size='4' maxlength='4' value=''/>\n";
	message +=
			"  Reflow Timer  <input name='processReflowTimer' type='text' id='textfield13' size='4' maxlength='4' value=''/><br>\n";
	message +=
			"  Kp  <input name='Kp' type='text' id='textfield13' size='5' maxlength='5' value='"
					+ String(Kp) + "'/>\n";
	message +=
			"  Ki  <input name='Ki' type='text' id='textfield13' size='5' maxlength='5' value='"
					+ String(Ki) + "'/>\n";
	message +=
			"  Kd  <input name='Kd' type='text' id='textfield13' size='5' maxlength='5' value='"
					+ String(Kd) + "'/>\n";
	message +=
			"  Agressive Seconds  <input name='processAgressiveness' type='text' id='textfield13' size='2' maxlength='2' value='"
					+ String(processAgressiveness) + "'/>\n";
	message +=
			"  Hysteresis  <input name='processTempHysteresis' type='text' id='textfield13' size='1' maxlength='1' value='"
					+ String(processTempHysteresis) + "'/><br>\n";
	message +=
			"  System Message <input name='systemMessage' type='text' id='textfield13' size='70' maxlength='70' value='"
